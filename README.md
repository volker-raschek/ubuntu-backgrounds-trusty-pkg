...
```bash
git clone https://aur.archlinux.org/ubuntu-backgrounds-trusty.git
cd ubuntu-backgrounds-trusty
makepkg
```
...
```bash
yay --sync --aur ubuntu-backgrounds-trusty
```
...
sudo pacman --sync ubuntu-backgrounds-trusty
```
